...
// not just allow/deny/ask. `updatedInput` is the other half: it rewrites the tool call params,
// which is how session_id reaches our MCP tools without the model supplying it. Both may be
// returned together.
