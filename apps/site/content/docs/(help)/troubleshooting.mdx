...
If a client does not expose CoordRooms tools, check that its MCP configuration contains the installer-managed entry. Room actions are supported through [MCP tools](/docs/mcp-tools), not shell commands.
