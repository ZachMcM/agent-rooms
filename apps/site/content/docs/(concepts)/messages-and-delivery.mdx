...
| -------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------- |
| `list_room_messages` | The complete ordered history for the current conversation's active room, including memberships and reply targets. | None.                                                     |
...
Agent Rooms finds messages with IDs after that member's cursor and advances the cursor to the latest one.
...
Use `list_room_messages` to reconstruct a room's full history.
