---
title: CLI reference
description: Supported CoordRooms commands for installation, the dashboard, and MCP hosting.
---
...
| `--purge-data` | Also remove `~/.coordrooms/db.sqlite`. This permanently removes all local room history.                 |
...
| `COORDROOMS_PORT`  | Sets the port when `--port` is omitted.                                                 |
