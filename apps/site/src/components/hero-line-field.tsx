const leftPaths = [
  ...
  'M0 220H100V280H185V320H240V340',
  'M0 365H120V340H240',
...
const topPaths = [
  ...
  'M250 0V65H330V125H384V160',
  'M520 0V45H450V100H400V160H384',
...
const bottomPaths = [
  ...
  'M250 160V95H330V35H384V0',
  'M520 160V115H450V60H400V0H384',
...
export function HeroLineField() {
  return (
    <div
      aria-hidden="true"
      className="text-border pointer-events-none absolute inset-0 grid grid-cols-[1fr_minmax(0,48rem)_1fr] grid-rows-[1fr_minmax(0,22rem)_1fr] opacity-80"
    >
